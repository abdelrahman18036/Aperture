<!-- Source: https://orm.drizzle.team/docs/pg/v0-v1-changes -->
...
RQBv1 has been removed. Use [Relational Queries v2](/docs/relations) with the new `defineRelations()` API instead and new features. You can find more details about migrating from rqb v1 to v2 [here](/docs/relations-v1-v2)
...
- drizzle-typebox -> [drizzle-orm/typebox-legacy](/docs/typebox-legacy) (using @sinclair/typebox)
- drizzle-typebox -> [drizzle-orm/typebox](/docs/typebox) (using typebox)
...
`drizzle-kit generate` now identifies [incompatible changes](/docs/v0-v1-changes#drizzle-kit-check--commutativity-check) across migration branches. Use `--ignore-conflicts` to bypass.
