...
Now go build something awesome with Drizzle and your **[PostgreSQL](/docs/get-started-postgresql)**, **[MySQL](/docs/mysql/get-started-mysql)**, **[SQLite](/docs/sqlite/get-started-sqlite)**, **[MSSQL](/docs/mssql/get-started-mssql)** or **[CockroachDB](/docs/cockroach/get-started-cockroach)** database. 🚀
...
<YoutubeCards cards={[
	...
	/*
	This video became private
	Uncomment (in other files too) it when it becomes public again
	{
		id: "3tl9XCiQErA",
